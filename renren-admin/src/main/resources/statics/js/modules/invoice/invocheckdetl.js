$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '发票代码', name: 'invoiceDataCode', index: 'invoice_data_code', width: 80 }, 			
			...
			{ label: '发票类型', name: 'invoiceTypeCode', index: 'invoice_type_code', width: 80 },
			{ label: '开票时间', name: 'billingTime', index: 'billing_time', width: 80 },
			...
			{ label: '购方名称', name: 'purchaserName', index: 'purchaser_name', width: 80 }, 			
			...
			{ label: '销方名称', name: 'salesName', index: 'sales_name', width: 80 }, 			
			...
			{ label: '价税合计', name: 'totalTaxSum', index: 'total_tax_sum', width: 80 }, 			
			{ label: '税额', name: 'totalTaxNum', index: 'total_tax_num', width: 80 },
			...
			{ label: '录入日期', name: 'crtDt', index: 'crt_dt', width: 80 },
